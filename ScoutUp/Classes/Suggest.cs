    ...
    public class Suggest
    {
        public List<FollowSuggestViewModel> FollowSuggest(string userId,ScoutUpDB _db,bool nearby=false)
        {
            ...
            foreach (var similarity in similartiesOrdered)
            {
                ...
                var temp = new FollowSuggestViewModel {UserId = similarity.OtherUserID, Name = tempUser.UserFirstName + " " + tempUser.UserSurname,ImagePath = tempUser.UserProfilePhoto,
